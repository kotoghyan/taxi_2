...
$to ='Fast1Taxi@yandex.ru'; // нужно свой майл вписать.



$Subject='Заявка с сайта фаст такси'; //.$_SERVER['HTTP_HOST']; // тема приходящего письма
...
echo $message = mb_wordwrap($msg, 70, "\r\n");
...
<noscript><div><img src="https://mc.yandex.ru/watch/92194010" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</body> </html>
